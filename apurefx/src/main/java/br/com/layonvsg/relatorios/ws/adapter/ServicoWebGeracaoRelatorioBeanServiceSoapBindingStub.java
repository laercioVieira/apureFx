/**
 * ServicoWebGeracaoRelatorioBeanServiceSoapBindingStub.java
 *
...
public class ServicoWebGeracaoRelatorioBeanServiceSoapBindingStub extends org.apache.axis.client.Stub implements br.com.layonvsg.relatorios.ws.adapter.ServicoWebGeracaoRelatorio {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setName("gerarRelatorioExtratoConsolidadoDeAtivos");
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("gerarRelatorioOperacoesDerivativosRealizadasDia");
        ...
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "dataPregao"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "dateTime"), java.util.Calendar.class, false, false);
        param.setOmittable(true);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "idCorretora"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"), double.class, false, false);
        oper.addParameter(param);
        param = new org.apache.axis.description.ParameterDesc(new javax.xml.namespace.QName("", "idCliente"), org.apache.axis.description.ParameterDesc.IN, new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"), double.class, false, false);
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://adapter.ws.relatorios.temasistemas.com.br/", "log"));
    ...
    public ServicoWebGeracaoRelatorioBeanServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ServicoWebGeracaoRelatorioBeanServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ServicoWebGeracaoRelatorioBeanServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public br.com.layonvsg.relatorios.ws.adapter.Log[] gerarRelatorioExtratoConsolidadoDeAtivos(double idCliente, java.util.Calendar dataInicio) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://adapter.ws.relatorios.temasistemas.com.br/", "gerarRelatorioExtratoConsolidadoDeAtivos"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Double(idCliente), dataInicio});
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Long(instituicaoId), new java.lang.Long(corretoraId), new java.lang.Long(clienteId), dataLiquidacao});
  ...
  throw axisFaultException;
    ...
    public br.com.layonvsg.relatorios.ws.adapter.Log[] gerarRelatorioAtivosDisponiveis() throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://adapter.ws.relatorios.temasistemas.com.br/", "gerarRelatorioAtivosDisponiveis"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public br.com.layonvsg.relatorios.ws.adapter.Log[] gerarRelatorioOperacoesDerivativosRealizadasDia(double idInstituicao, java.util.Calendar dataPregao, double idCorretora, double idCliente) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://adapter.ws.relatorios.temasistemas.com.br/", "gerarRelatorioOperacoesDerivativosRealizadasDia"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {new java.lang.Double(idInstituicao), dataPregao, new java.lang.Double(idCorretora), new java.lang.Double(idCliente)});
