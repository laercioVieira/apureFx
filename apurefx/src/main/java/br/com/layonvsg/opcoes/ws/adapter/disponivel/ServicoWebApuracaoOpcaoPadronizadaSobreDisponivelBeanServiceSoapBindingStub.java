/**
 * ServicoWebApuracaoOpcaoPadronizadaSobreDisponivelBeanServiceSoapBindingStub.java
 *
...
public class ServicoWebApuracaoOpcaoPadronizadaSobreDisponivelBeanServiceSoapBindingStub extends org.apache.axis.client.Stub implements br.com.layonvsg.opcoes.ws.adapter.disponivel.ServicoWebApuracaoOpcaoPadronizadaSobreDisponivel {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.addParameter(param);
        oper.setReturnType(new javax.xml.namespace.QName("http://disponivel.adapter.ws.opcoes.temasistemas.com.br/", "log"));
        oper.setReturnClass(br.com.layonvsg.opcoes.ws.adapter.disponivel.Log[].class);
    ...
    public ServicoWebApuracaoOpcaoPadronizadaSobreDisponivelBeanServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ServicoWebApuracaoOpcaoPadronizadaSobreDisponivelBeanServiceSoapBindingStub(final java.net.URL endpointURL, final javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ServicoWebApuracaoOpcaoPadronizadaSobreDisponivelBeanServiceSoapBindingStub(final javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://disponivel.adapter.ws.opcoes.temasistemas.com.br/", "log");
            cachedSerQNames.add(qName);
            cls = br.com.layonvsg.opcoes.ws.adapter.disponivel.Log.class;
	...
	public br.com.layonvsg.opcoes.ws.adapter.disponivel.Log[] apurar(final java.util.Calendar dataAtual, final java.util.Calendar dataAnterior, final int instituicaoId) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://disponivel.adapter.ws.opcoes.temasistemas.com.br/", "apurar"));
 ...
 try {        final java.lang.Object _resp = _call.invoke(new java.lang.Object[] {dataAtual, dataAnterior, new java.lang.Integer(instituicaoId)});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (br.com.layonvsg.opcoes.ws.adapter.disponivel.Log[]) _resp;
            } catch (final java.lang.Exception _exception) {
                return (br.com.layonvsg.opcoes.ws.adapter.disponivel.Log[]) org.apache.axis.utils.JavaUtils.convert(_resp, br.com.layonvsg.opcoes.ws.adapter.disponivel.Log[].class);
            }
        }
